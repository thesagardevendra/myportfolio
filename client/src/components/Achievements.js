...
import hotstarImage from '../assets/hotstar.png'
...
const Achievements = () => {
    return (
        <div className='flex flex-col md:px-20 px-4 md:pt-32 pt-24 relative' style={{ zIndex: 1 }}>
            ...
            <div className='text-cyan-500 text-5xl font-semibold'><i className='fa fa-award text-yellow-500 text-6xl mr-3'></i>Achievements</div>
            ...
            <ol class="relative border-s dark:border-gray-500 my-8 mt-20 border-cyan-500">
                <li class="mb-10 ms-6">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-cyan-800 rounded-full -start-3 ring-8 ring-cyan-500 dark:ring-cyan-400 dark:bg-cyan-200">
                        <i className='fa fa-circle text-cyan-500 text-xs'></i>
                    </span>
                    <h3 class="flex items-center mb-1 ml-2 text-xl font-semibold text-cyan-500 dark:text-gray-500">Mobile Friendly Web Pages</h3>
                    <div className='flex flex-col lg:flex-row gap-10 lg:gap-0'>
                        <div className='flex flex-grow flex-col flex-1 justify-between'>
                            <div className=' flex flex-col gap-6 justify-center ml-2 text-sm font-normal  text-gray-400 dark:text-gray-500'>
                                ...
                                <a href='https://thesagardevendra.github.io/musica-pp/#/home' target='_blank' className='bg-cyan-500 px-3 hover:scale-105 transition-all duration-300 py-1.5 w-[150px] text-center rounded -mt-3 text-white  block'>View Live App <i className='fa fa-external-link ml-1 '></i></a>
                                {/* Desktop */}
                                <div className=''>
                                    <div class="relative mx-auto border-gray-800 dark:border-gray-500 bg-gray-800 border-[8px] rounded-t-xl h-[172px] max-w-[301px] md:h-[265px] md:max-w-[512px]">
                                        <div class="rounded-lg overflow-hidden h-[156px] md:h-[240px] bg-gray-800 dark:bg-gray-800">
                                            <img src={desktopImage} class=" object-cover h-[156px] md:h-[240px] w-full rounded-xl" alt="" />
                                        </div>
                                    </div>
                                    <div class="relative mx-auto bg-gray-900 dark:bg-gray-500 rounded-b-xl h-[24px] max-w-[301px] md:h-[42px] md:max-w-[512px]"></div>
                                    <div class="relative mx-auto bg-gray-800 dark:bg-gray-600 rounded-b-xl h-[55px] max-w-[83px] md:h-[95px] md:max-w-[142px]"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='lg:flex-1'>
                            {/* Mobile */}
                            <div class="relative mx-auto border-gray-800 dark:border-gray-500 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-xl ">
                                {/* <div class="w-[148px] h-[18px] bg-gray-800 top-0 rounded-b-[1rem] left-1/2 -translate-x-1/2 absolute"></div> */}
                                <div class="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[124px] rounded-s-lg"></div>
                                <div class="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[178px] rounded-s-lg"></div>
                                <div class="h-[64px] w-[3px] bg-gray-800 absolute -end-[17px] top-[142px] rounded-e-lg"></div>
                                <div class="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white dark:bg-gray-800">
                                    <img src={mobileImage} class="object-cover w-[272px] h-[572px]" alt="" />
                                </div>
                            </div>
                        </div>
                ...
                <li class="mb-10 ms-6">
                    ...
                    <h3 class="flex items-center mb-1 ml-2 text-lg font-semibold text-cyan-500 dark:text-gray-500">Theme Toggling Feature</h3>
                    <div className='flex flex-grow flex-col flex-1 justify-between'>
                        <div className=' flex flex-col gap-6 ml-2 text-sm font-normal  text-gray-400 dark:text-gray-500'>
                            ...
                            <a href='https://silly-nasturtium-528fd2.netlify.app/home' target='_blank' className='bg-cyan-500 px-3 hover:scale-105 transition-all duration-300 py-1.5 w-[150px] text-center rounded -mt-3 text-white  block'>View Live App <i className='fa fa-external-link ml-1 '></i></a>
                            <span className='text-red-600'>* You can experience Theme toggling by clicking the above sun icon in the header! </span>
                            {/* Desktop */}
                            <div className='self-start'>
                                <div class="relative mx-auto border-gray-800 dark:border-gray-500 bg-gray-800 border-[8px] rounded-t-xl h-[172px] max-w-[301px] md:h-[265px] md:max-w-[512px]">
                                    <div class="rounded-lg overflow-hidden h-[156px] md:h-[240px] bg-gray-800 dark:bg-gray-800">
                                        <img src={darkImage} class="dark:hidden object-cover h-[156px] md:h-[240px] w-full rounded-xl" alt="" />
                                        <img src={lightImage} class="hidden dark:block object-cover h-[156px] md:h-[240px] w-full rounded-xl" alt="" />
                                    </div>
                                </div>
                                <div class="relative mx-auto bg-gray-900 dark:bg-gray-500 rounded-b-xl h-[24px] max-w-[301px] md:h-[42px] md:max-w-[512px]"></div>
                                <div class="relative mx-auto bg-gray-800 dark:bg-gray-600 rounded-b-xl h-[55px] max-w-[83px] md:h-[95px] md:max-w-[142px]"></div>
                ...
                <li class="mb-10 ms-6">
                    ...
                    <h3 class="flex items-center mb-1 ml-2 text-lg font-semibold text-cyan-500 dark:text-gray-500">E-Commerce Web App</h3>
                    ...
                    <a href='https://silly-nasturtium-528fd2.netlify.app/home' target='_blank' className='bg-cyan-500 px-3 hover:scale-105 transition-all duration-300 py-1.5  text-sm mt-3 w-[150px] text-center rounded  text-white  block'>View Live App <i className='fa fa-external-link ml-1 '></i></a>
                </li>
                <li class="mb-10 ms-6">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-cyan-800 rounded-full -start-3 ring-8 ring-cyan-500 dark:ring-cyan-400 dark:bg-cyan-200">
                        <i className='fa fa-circle text-cyan-500 text-xs'></i>
                    </span>
                    <h3 class="flex items-center mb-1 ml-2 text-lg font-semibold text-cyan-500 dark:text-gray-500">Music Web Player</h3>
                    ...
                    <a href='https://thesagardevendra.github.io/musica-pp/#/home' target='_blank' className='bg-cyan-500 px-3 hover:scale-105 transition-all duration-300 py-1.5  text-sm mt-3 w-[150px] text-center rounded  text-white  block'>View Live App <i className='fa fa-external-link ml-1 '></i></a>
                </li>
                <li class="mb-10 ms-6">
                    <span class="absolute flex items-center justify-center w-6 h-6 bg-cyan-800 rounded-full -start-3 ring-8 ring-cyan-500 dark:ring-cyan-400 dark:bg-cyan-200">
                        <i className='fa fa-circle text-cyan-500 text-xs'></i>
                    </span>
                    <h3 class="flex items-center mb-1 ml-2 text-lg font-semibold text-cyan-500 dark:text-gray-500">SMFG India (Formerly Fullerton India) Credit Company Limited</h3>
                    <div className=' flex flex-col gap-6 ml-2 text-sm font-normal  text-gray-400 dark:text-gray-500'>
                        <ul class=" ml-2 mb-2 flex flex-col items-center gap-2  text-sm lg:w-1/2   text-gray-400 dark:text-gray-500">
                ...
                <li class="mb-10 ms-6">
                    ...
                    <h3 class="flex items-center mb-1 ml-2 text-lg font-semibold text-cyan-500 dark:text-gray-500"> Aion Infosystems Private Limited</h3>
                    <div className=' flex flex-col gap-6 ml-2 text-sm font-normal  text-gray-400 dark:text-gray-500'>
                        <ul class=" ml-2 mb-2 flex flex-col items-center gap-2  text-sm lg:w-1/2   text-gray-400 dark:text-gray-500">
                ...
                <li class="mb-10 ms-6">
                    ...
                    <h3 class="flex items-center mb-1 ml-2 text-lg font-semibold text-cyan-500 dark:text-gray-500">Cloned Website's</h3>
                    ...
                    <div className=' flex flex-wrap gap-6 ml-2 text-sm mt-5 font-normal  text-gray-400 dark:text-gray-500'>
                        ...
                        <div className='self-start'>
                            <div class="relative mx-auto border-gray-800 dark:border-gray-500 bg-gray-800 border-[8px] rounded-t-xl h-[172px] max-w-[301px] md:h-[265px] md:max-w-[512px]">
                                <div class="rounded-lg overflow-hidden h-[156px] md:h-[240px] bg-gray-800 dark:bg-gray-800">
                                    <img src={hotstarImage} class=" object-cover h-[156px] md:h-[240px] w-full rounded-xl" alt="" />
                                </div>
                            </div>
                        ...
                        <div className='self-start'>
                            <div class="relative mx-auto border-gray-800 dark:border-gray-500 bg-gray-800 border-[8px] rounded-t-xl h-[172px] max-w-[301px] md:h-[265px] md:max-w-[512px]">
                                <div class="rounded-lg overflow-hidden h-[156px] md:h-[240px] bg-gray-800 dark:bg-gray-800">
                                    <img src={amazonImage} class="object-cover h-[156px] md:h-[240px] w-full rounded-xl" alt="" />
                                </div>
                            </div>
                            <div class="relative mx-auto bg-gray-900 dark:bg-gray-700 rounded-b-xl rounded-t-sm h-[17px] max-w-[351px] md:h-[21px] md:max-w-[597px]">
                                <div class="absolute left-1/2 top-0 -translate-x-1/2 rounded-b-xl w-[56px] h-[5px] md:w-[96px] md:h-[8px] bg-gray-800"></div>
                ...
                <li class="mb-10 ms-6">
                    ...
                    <h3 class="flex items-center mb-1 ml-2 text-lg font-semibold text-cyan-500 dark:text-gray-500">Task Management System <span class="dark:bg-cyan-200 dark:text-cyan-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded bg-cyan-900 text-cyan-300 ms-3">Coming Live Soon</span></h3>
                    <div className=' flex flex-col gap-6 ml-2 text-sm font-normal  text-gray-400 dark:text-gray-500'>
                        <ul class=" ml-2 mb-2 flex flex-col items-center gap-2  text-sm lg:w-1/2   text-gray-400 dark:text-gray-500">
                        ...
                        <div className='self-start'>
                            <div class="relative mx-auto border-gray-800 dark:border-gray-500 bg-gray-800 border-[8px] rounded-t-xl h-[172px] max-w-[301px] md:h-[265px] md:max-w-[512px]">
                                <div class="rounded-lg overflow-hidden h-[156px] md:h-[240px] bg-gray-800 dark:bg-gray-800">
                                    <img src={taskMImage} class="object-cover h-[156px] md:h-[240px] w-full rounded-xl" alt="" />
                                </div>
                            </div>
                            <div class="relative mx-auto bg-gray-900 dark:bg-gray-500 rounded-b-xl h-[24px] max-w-[301px] md:h-[42px] md:max-w-[512px]"></div>
                            <div class="relative mx-auto bg-gray-800 dark:bg-gray-600 rounded-b-xl h-[55px] max-w-[83px] md:h-[95px] md:max-w-[142px]"></div>
